...
<jsp:include page="/modules/head.jsp" />
	...
	<div class="one_column">
		...
		out.println("<h2>Hi, " + creatorName + ", please add question No." + position + " to \"" + quizName + "\"</h2>");
        ...
        <ul>
			...
			<li class="highlight">
				<label class="quiz_title" >Please input URL of image:<sup>*</sup></label>
				<div>
					<textarea id="pictureURL" name="Field3" class="field textarea small" rows="10" cols="50" tabindex="7" onkeyup="validateRange(8, 'character');"></textarea>
