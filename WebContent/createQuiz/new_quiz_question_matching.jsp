...
<div class="container">
	...
	<div class="one_column">
        ...
        <ul>
			...
			<li class="highlight">
				<label class="quiz_title" >Please input the label of correct choice(label first choice as 1), use comma "," at the end of each answer to specify one answer:<sup>*</sup></label>
				<div>
